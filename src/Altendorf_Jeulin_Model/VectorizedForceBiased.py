...
import cython
import numpy as np
from Altendorf_Jeulin_Model.VectorizedCalculateForces import *
...
def run_force_biased_vectorized(
    fs: list[Fiber],
    image_size,
    ...
    force_strength, overlap, neighbor_dist, angle_diff = calculate_forces_vectorized(
